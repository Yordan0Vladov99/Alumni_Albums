...
<head>
    ...
    function registerUser(){
        ...
        if(this.responseText=="User already exist"){
            document.getElementById("username-error").style.display="inline-block"
            document.getElementById("password-error").style.display="none"
            ...
            var user={}
            if(this.responseText=="Registration is successful. Welcome, photographer."){
    ...
    xmlhttp.open("GET","registerUser.php?username="+username+"&password="+password,true);
    xmlhttp.send();
    }
 }
...
<div class="RegistrationForm" action="registerUser.php" method="post">
<h1 class="headers">Registration</h1>
        ...
        <button onclick="registerUser()" class="submit-btn" name="submit" value="Submit">Submit</button> 
</div>
</body>
